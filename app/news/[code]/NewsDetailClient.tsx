...
export default function NewsDetailClient({ newsItem, recentNews }: NewsDetailClientProps) {
    const title = newsItem.tags.includes("Articles") 
        ? "Articles​" 
        : newsItem.tags.includes("Interviews") 
            ? "Interviews​" 
            : 'Press Release';
