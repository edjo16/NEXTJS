...
import logoMobile from "/images/logo2.webp"
...
function useNavbarLogic() {
  ...
  const handleScroll = useCallback(() => {
    ...
    setScrolledHero(window.scrollY > 80);
    if (!isMobile) {
              ...
              <div className={`py-2 ${isMobile ? "w-full" : "max-w-xl sm:px-4 xl:px-0"}`}>
                <div className={`flex flex-col`}>
                  ...
                  <Link href="/" className={isMobile ? "self-start" : ""}>
                    <Image src={isMobile ? logoMobile : logo} alt="Active RE" width={isMobile ? 120 : 180} height={36} className="h-9 w-auto" priority />
                  </Link>
