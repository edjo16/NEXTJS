  ...
  return (
    <>
      ...
      <nav
        ...
        className={`hidden md:flex fixed right-4 md:pt-12 top-1/2 -translate-y-1/2 z-30 flex-col gap-3 ${className}`}
      >
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Icon button */}
              <span
                className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-white text-cyan-800 shadow-lg ring-1 ring-black/5 transition-colors hover:bg-cyan-700 hover:text-white"
              >
                {item.icon}
              </span>
            </a>
